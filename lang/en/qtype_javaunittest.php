...
$string['RSNOTCOMP'] = 'REMOTE SERVER ERROR: Compiling and executing machine not available. Please try again later or contact the module responsible person.';
$string['RSFORBIDDEN'] = 'REMOTE SERVER ERROR: Connection refused by server.';
$string['RSWRONGVERSION'] = 'REMOTE SERVER ERROR: Server version differs. Please contact the module responsible person.';
$string['TO'] = 'TIMEOUT: The execution time limit is reached.';
$string['compiling'] = 'compiling... [{$a}s]';
$string['running'] = 'running... [{$a}s]';
$string['outofmemory'] = 'OutOfMemoryError occurred';
$string['stackoverflow'] = 'StackOverflowError occurred';
...
$string['remoteserver_desc'] = 'Give a URL to a remote machine if you want remote compiling and test running. Otherwise leave this empty if you wish execution on this server. The remote server may override the settings for memory and time limit.';
