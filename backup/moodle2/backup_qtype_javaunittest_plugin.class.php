...
class backup_qtype_javaunittest_plugin extends backup_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $javaunittest = new backup_nested_element('javaunittest', array('id'), array(
            'responsefieldlines', 'givencode', 'testclassname', 'junitcode'));

        // Now the own qtype tree.
        $pluginwrapper->add_child($javaunittest);

        // Set source to populate the data.
        $javaunittest->set_source_table('qtype_javaunittest_options',
